export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'conter-goods',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Conter Goods',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'conter-goods.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://conter-goods.com',
